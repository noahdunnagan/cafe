...
name: audit-all
command: audit-all
description: ☕️ cafe · Run /audit in parallel across multiple directories using isolated git worktrees. One PR per directory with real fixes; no PR for clean ones. Usage: /audit-all <glob-or-list> (e.g. /audit-all ./plugins/*/, /audit-all packages/foo packages/bar)
---
