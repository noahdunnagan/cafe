...
name: code-audit
command: audit
description: ☕️ cafe · Audit a directory for security, performance, safety, and cleanup issues. Applies real fixes only — no churn. Opens a PR if there are real fixes, otherwise reports clean. Usage: /audit <path> (defaults to repo root).
---
